...
A personal portfolio website built from scratch using [Blazor](https://dotnet.microsoft.com/apps/aspnet/web-apps/blazor).
...
- **C#**: Built with Blazor for fast, interactive UI and easily customizable
...
- Update content in the `Pages/` directory to personalize your portfolio.
- Add your projects and skills as needed.
...
|---------|------------|------|
| v0.0.1-alpha.1 | Initial | https://github.com/TirsvadWeb/Dotnet.Portfolio/tree/v0.0.1-alpha.1 |
